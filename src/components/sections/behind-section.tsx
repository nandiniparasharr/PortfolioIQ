    ...
    <section id="behind" className="relative scroll-mt-32 border-t border-border/60 py-16 lg:py-20">
      <div className="mx-auto max-w-3xl px-6">
        ...
        <div className="mt-6 space-y-5 text-sm leading-relaxed text-muted-foreground lg:text-base">
          <p>
            I&apos;ve always been curious about how portfolios work and how studying them can help
            people make better investment decisions. PortfolioIQ started as a side project to
            explore that curiosity and eventually became a product I genuinely enjoyed building.
          </p>
          <p>
          ...
          <p>
            I&apos;m still working on improving PortfolioIQ, one feature at a time. If you have any
            feedback, ideas, or just want to talk about investing, markets, or building interesting
